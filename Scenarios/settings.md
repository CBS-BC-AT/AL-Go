...
| <a id="templateFiles"></a>templateFiles | A list of paths to folders and files that will be compared during CheckForUpdate jobs and updated during "Update AL-Go System Files" runs.<br />If the leaf element contains a wildcard character `*`, it will be used as a file pattern applied to all cildren of the parent folder. |
